...
def JogoDaVelha():
    ...
    def Turno(jogador):
        if jogador == "X":
            ...
            espaco_colocado = EscolherJogadaSistema()
    ...
    def EscolherJogadaSistema():
        espacos_vazios = [i for i, valor in enumerate(tabuleiro) if valor != "X" and valor != "O"]
        jogada_sistema = random.choice(espacos_vazios)
        return jogada_sistema
